= ModuleBook Level 3 - Developer Guide
...
* 2b. User requests to track the module
* 2c. The module is now tracked
+
...
* 3b. User provides a description
* 3c. ModuleBook requests for a datetime
* 3d. User provides a datetime
[none]
** 3d1. User provided invalid datetime
** 3d2. Display error message and go to step 3c
